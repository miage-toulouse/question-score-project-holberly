...
public class ScoreCalculateurTest {
    ...
    public void testCalculeScore() {
        ...
        //when : on fourni trois bonnes réponses et deux mauvaises réponses
        //and : on demande le calcul du score
        resScore = unScore.calculeScore(new ArrayList<Integer>(Arrays.asList(1,2,3,4,5)), questionAChoixMultiple);
        //then : le score est bien à 0
        assertEquals(new Float(0f), resScore, 0.01f);
        //when : on fourni deux bonnes réponses et une mauvaise réponse
        //and : on demande le calcul du score
        resScore = unScore.calculeScore(new ArrayList<Integer>(Arrays.asList(1,2,3)), questionAChoixMultiple);
        //then : le score est bien à 16.66
